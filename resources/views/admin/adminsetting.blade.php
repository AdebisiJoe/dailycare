            ...
            <div class = "tab-content">
                <div class = "active tab-pane" id = "home">
                    ...
                    @else
                         ...
                         <form role = "form" class = "form-horizontal" id = "defaultForm" method = "post" action = "{{url('/registerfirstuser')}}">
                       <!--/.personal box -->
                ...
                <div class = "tab-pane" id = "messages">
                    <!--The timeline -->
                    <form role = "form" class = "form-horizontal" method = "post" action = "{{url('/registeradmin')}}">
                        <div class = "box-body">
                    ...
                    <form >
                        <div class = "form-group">
                            <table class = "table table-bordered">
                                ...
                                <tbody>
                                    @foreach($mlmlevel as $mlmlevels)
                                    <tr>
                                        <td> <input type = "text" name = "levelname[]" id = "levelname_1" class = "form-control" value = "{!!$mlmlevels->name!!}" ></td>
                                        <td><input type = "text" name = "level[]" data-type = "productName" id = "level_1" value = "{!!$mlmlevels->stage_number!!}" class = "form-control"></td>
                                        <td><input type = "text" name = "stage[]" data-type = "productName" id = "stage_1" value = "{!!$mlmlevels->stage_number!!}" class = "form-control"></td>
                                        <td><input type = "text" name = "dowlines[]" id = "dowlines_1" class = "form-control" value = "{!!$mlmlevels->noofdownlines!!}" onkeypress = "return IsNumeric(event);" ></td>
                                        <td><input type = "text" name = "bonus[]" id = "bonus_1" class = "form-control" value = "{!!$mlmlevels->bonus!!}" onkeypress = "return IsNumeric(event);" ></td>
                        ...
                        <div class = "form-group">
                            <table class = "table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> <input type = "text" name = "countryname[]" id = "countryname_1" class = "form-control" value = "{!!$countrycurrency->name!!}" ></td>
                                        <td><input type = "text" name = "currency[]" data-type = "productName" id = "currency_1" value = "{!!$countrycurrency->currencyname!!}" class = "form-control"></td>

                                        <td><input type = "text" name = "foodequ[]" data-type = "productName" id = "foodequ_1" value = "{!!$countrycurrency->foodequ!!}" class = "form-control"></td>
                                        <td><input type = "text" name = "htmlcode[]" data-type = "productName" id = "htmlcode_1" value = "{!!$countrycurrency->htmlcode!!}" class ="form-control"></td>
