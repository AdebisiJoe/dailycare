    ...
    <section class="content">
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" method="post"  enctype="multipart/form-data" action="{{ url('/create/award/categories') }}">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" value="" placeholder="Product Name" id="input-name1" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="description" value="" placeholder="Category Description" id="input-name1" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="1"  max="12" name="month_duration" value="" placeholder="Award month duration" id="input-name1" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="0"  max="5" name="stage" value="" placeholder="Stage Completed" id="input-name1" class="form-control" />
                        </div>
                    </div>
