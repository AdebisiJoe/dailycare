    ...
    <section class="content">
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" method="post"  enctype="multipart/form-data" action="{{ url('/update/award/categories/contents/')}}/{!!$awardcategorycontent->id!!}">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="award_type_id" class="form-control" name="good_type" id="categoryID" onselect="getSubCategory()" onchange="getSubCategory()">
                                <option value="fooditem" <?php if($awardcategorycontent->good_type == 'fooditem') echo "selected"?>>Food items</option>
                                <option value="accessories" <?php if($awardcategorycontent->good_type == 'accessories') echo "selected"?>>Accessories</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="award_category_id" class="form-control">
                                <option value="{!! $awardcategorycontent->awardcategory->id !!}">{!! $awardcategorycontent->awardcategory->name !!}</option>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            ...
                            <option value="{!! $awardcategorycontent->product->id!!}" selected>{!! $awardcategorycontent->product->item_name !!}</option>
                            <?php } ?>

                            <?php if($awardcategorycontent->good_type == 'accessories'){ ?>
                            <option value="{!! $awardcategorycontent->accessory->id!!}" selected>{!! $awardcategorycontent->accessory->name !!}</option>
                            <?php } ?>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="1"  max="50" name="quantity" value="{{$awardcategorycontent->quantity}}" placeholder="Quantity of Goods" id="input-name1" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="0"  max="1" name="visibility" value="{{$awardcategorycontent->visible}}" placeholder="Stage Completed" id="input-name1" class="form-control" />
                        </div>
                    </div>
