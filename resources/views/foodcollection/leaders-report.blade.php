...
<section class="content">
    <div class="box box-default hidden-print">
        <div class="box-header with-border">
            <h3 class="box-title">Group Leaders Food Collection Reports</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="" id="report-id" class="form-control" required="required">
                <option value="1">Group Manifest</option>
                <option value="2">Group Total Orders</option>
              </select>
            </div>
          </div>
          <br>
...
<script type="text/javascript">
  ...
  function generateReport() {
    ...
    var group_id = $('#group-id').val();
     ...
     $.ajax({
      url: '{{ url("/")}}/food-collection/leaders-reports/generate',
      type: 'get',
      data: 'report_id=' + report_id + '&date=' + date,
      dataType: 'html',
      beforeSend: function() {
