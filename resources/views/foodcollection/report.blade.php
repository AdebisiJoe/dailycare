    ...
    <div class="box box-default hidden-print">
        ...
        <div class="box-body">
          <div class="form-group">
            <label for="report-id" class="col-sm-2 control-label">Select Report </label>

            <div class="col-sm-10">
              <select name="" id="report-id" class="form-control" required="required">
                <option value="1">Group Members List</option>
                <option value="2">Group Leader's List</option>
                <option value="3">Procurement List</option>
                <option value="4">Groups Eligible For Collection</option>
              </select>
            </div>
          </div>
          <br>
          ...
          <br>
          <div class="form-group">
            <label for="group-id" class="col-sm-2 control-label">Select Group </label>

            <div class="col-sm-10">
              <select name="" id="group-id" class="form-control" required="required">
...
<script type="text/javascript">
  function printReport(divName) {
    ...
    function getGroups() {
      $.ajax({
          type:"GET",
          url:'{{ url("/")}}/food-collection/get_groups',
          dataType:'json',
  ...
  function generateReport() {
    ...
    var groupState = $('#inputGroupState').val();
     ...
     $.ajax({
      url: '{{ url("/")}}/food-collection/reports/generate',
      type: 'get',
      data: 'report_id=' + report_id + '&date=' + date + '&group_id=' + group_id + '&country=' + groupCountry + '&state=' + groupState,
      dataType: 'html',
      beforeSend: function() {
