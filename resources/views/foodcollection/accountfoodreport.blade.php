            ...
            <div class="box-body">
                <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="" id="subaccount_holder" id="input" class="form-control" required="required" >
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function() {
            getMembershipIdAndSubAccountIds()
    ...
    <script type="text/javascript">
        ...
        function generateReport() {
            var membershipid = $('#subaccount_holder').val();
            var date = $('#date').val();
            //var group_id = $('#group-id').val();
            //var startDate;
            //var    endDate;

           // date.val(startDate.format('{MM}/{dd}/{yyyy}') +'-'+ endDate.format('{MM}/{dd}/{yyyy}'));
            var formdata={membershipid:membershipid,date:date};
            ...
            $.ajax({
                type:"POST",
                url:"{!!URL::route('getaccountfoodreport')!!}",
                data:formdata,
                dataType:'json',
                beforeSend: function() {
        ...
        function getMembershipIdAndSubAccountIds()
        {


            $.ajax({
                    type:"GET",
                    url:"{!!URL::route('useraccountidandsubaccountid')!!}",
                    dataType:'json',
                    success:function(data){
                        console.log(data);
                        $('#subaccount_holder')
