...
<div class="steps-container">
    <ul class="steps">
        <li data-step="1" data-name="campaign" class="active">
            <span class="badge">1</span>Sponsor Information
            <span class="chevron"></span>
        </li>
        <li data-step="2">
            <span class="badge">2</span>Personal Information
            <span class="chevron"></span>
        </li>
        <li data-step="3" data-name="template">
            <span class="badge">3</span>Security Information
            <span class="chevron"></span>
        </li>
...
<div class="actions">
    ...
    <button type="button" class="btn btn-primary btn-next" data-last="">Next
...
<div class="step-content">
    <div class="step-pane active sample-pane alert" data-step="1">
           ...
           <div class = "form-group">
                                <div class = "col-md-2">
                                    <label for = "refferer">Sponsor Username</label>
                                </div>
                                <div class = "col-md-4">
                                    <input type = "text" class = "form-control" id = "refferer" name = "reffererusername" placeholder = "Enter Refferer Username">
                                </div>
                            </div>
                            ...
                            <div class = "form-group">
                                <div class = "col-md-2">
                                    <label for = "parentid">Parent Username</label>
                                </div>
                                <div class = "col-md-4">
                                    <input type = "text" class = "form-control" id = "parentid" name = "parentusername" placeholder = "Enter parent Username">
                                   
                                </div>
                                <span id="parentidindicator"></span>
                            </div>

                            <input type = "hidden" class = "form-control" id = "parentid" name = "role" placeholder = "" value="user">
                            ...
                            <div class = "form-group">
                                ...
                                <div class = "col-md-4">
                                    <select name="registernum" class="form-control">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $.ajax({
     ...
     $("#parentidindicator").html("<p style='color:red'>"+firstname+" "+ lastname+"</p>"); 
            }else{
