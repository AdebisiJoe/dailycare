...
class CreateTempcurrentamountABkTable extends Migration {
	...
	public function up()
	{
		Schema::create('tempcurrentamount_a_bk', function(Blueprint $table)
		{
	...
	{
		Schema::drop('tempcurrentamount_a_bk');
	}
