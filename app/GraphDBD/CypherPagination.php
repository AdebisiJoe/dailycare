   ...
   private $_row_start;
	...
	public function getData( $limit=10 , $page=1 ){
     ...
     if ($this->_limit=='all') {
      ...
      $this->_row_start= (( $this->_page )* $this->_limit);
      $queryTemplate = $this->_query . "LIMIT {$this->_row_start}, $this->_limit";

     }
     $cypher = new Query($GLOBALS['client'], $queryTemplate, array('membershipID'=>$data));
