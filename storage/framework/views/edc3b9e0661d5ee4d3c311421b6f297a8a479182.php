...
<script type="text/javascript">
  ...
  function generateReport() {
    ...
    if(strUser == 2){
        var date = $('#date').val();
        $.ajax({
            url: '<?php echo e(url("/")); ?>/admin-operation/members-financial-records-with-date',
            type: 'get',
            data: 'date=' + date,
            dataType: 'html',
        ...
        $.ajax({
            url: '<?php echo e(url("/")); ?>/admin-operation/members-financial-records',
            type: 'get',
            dataType: 'html',
  ...
  function generateReportForAmountGainedByDeduction() {
    $.ajax({
        url: '<?php echo e(url("/")); ?>/admin-operation/amount-gained-by-deduction',
        type: 'get',
        dataType: 'html',
