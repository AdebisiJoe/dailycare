               ...
               <form method="post" id="acceptForm">
                   <div class="container" style="position: fixed;top: 20%;max-width:80%;margin-left:0px;border:1px solid #eee;background: #000;">
                       ...
                       <div class="form-group acceptForm">
                            <input type="hidden" name="memid" id="memid" value="<?php echo e($membershipid); ?>"/>
...
&nbsp; &nbsp; &nbsp;
    ...
    <section class="content">
       <div class="col-md-offset-3 col-md-6">  <h3>Membershipid:  <?php echo e($membershipid); ?> Stage: <span id="stage"><?php echo e($stage); ?></span></h3></div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 col-xs-12">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-aqua">
                        ...
                        <div class="progress">
                            ...
                            <a style="color:#ffffff" href="<?php echo e(url('/showaccountdetails')); ?>" class="small-box-footer">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-yellow">
                        ...
                        <div class="progress">
                            ...
                            <span class="progress-description">
                            <a style="color:#ffffff" href="<?php echo e(url('/showdownlines')); ?>" class="small-box-footer">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <!--        </div>-->
                    <!--        <a href="<?php echo e(url('/awards')); ?>" class="small-box-footer">-->
         ...
         $(document).ready(function () {
            ...
            $(".acceptbtn").click(function () {
                ...
                if ($("#acceptBox").is(':checked')) {
                    ...
                    $("#loader").html("<img src='<?php echo e(asset('images/availableimg/ajax-loader.gif')); ?>'/>");
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo URL::route('acceptTerms'); ?>",
                        dataType: 'json',
