...
<head>
  ...
  <title>Unique Foods Solutions</title>
  <!-- Favicon -->
  ...
  <!-- Progress bar  -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/css/bootstrap-progressbar-3.3.4.css')); ?>">   
  <!-- Theme color -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/css/theme-color/orange-theme.css')); ?>">  
  <link rel="stylesheet" href="<?php echo e(asset('plugins/fuelux/fuelux.min.css')); ?>">  
  <!-- Main Style -->
        ...
        <div class="modal-dialog">
          ...
          <div id="login-content" class="modal-content">
            ...
            <div class="modal-footer footer-box">
              ...
              <span>No account ? <a  href="<?php echo e(url('/join-now')); ?>">Register</a></span>            
            </div>
          </div>
        ...
        <nav class="navbar navbar-default" role="navigation">  
          <div class="container">
            <div class="navbar-header">
              ...
              <!-- LOGO -->              
              <!-- TEXT BASED LOGO -->
              <a class="navbar-brand" href="<?php echo e(url('/index')); ?>" style="max-width:200px;"> 
               <img src="<?php echo e(asset('images/pagelogo.png')); ?>" alt="LOGO" class="img-responsive" />
             </a>              
             <!-- IMG BASED LOGO  -->
           ...
           <div id="navbar" class="navbar-collapse collapse">
            <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
              ...
              <li><a href="<?php echo e(url('/compensation-plan')); ?>">Compensation plan</a></li>
           <!--<li><a href="<?php echo e(url('/service')); ?>">Service</a></li>
            <li><a href="<?php echo e(url('/faq')); ?>">Faq</a></li> 
            <li><a href="<?php echo e(url('/how-it-works')); ?>">How it works</a></li>-->
            <li><a href="<?php echo e(url('/join-now')); ?>">Join now</a></li>
            <li><a href="<?php echo e(url('/login')); ?>">Login</a></li>
            <!--<li><a href="<?php echo e(url('/foundation')); ?>">Foundation</a></li>-->
...
<ul class="list-group dash-nav" style="position:fixed; right:0px; top:50%; width:50px; height:200px;">
  <li class="list-group-item"><a href="<?php echo e(url('/home')); ?>"><i class="fa fa-user" style="color:green;"></i></a></li>
  <li class="list-group-item bg-success"><a href="<?php echo e(url('/logout')); ?>"><i class="fa fa-power-off" style="color:red";></i></a></li>
</ul>
<?php endif; ?>
...
<!-- Add fancyBox -->        
<script type="text/javascript" src="<?php echo e(asset('assets/js/jquery.fancybox.pack.js')); ?>"></script>  
<!-- counter -->
<script type="text/javascript" src="<?php echo e(asset('assets/js/waypoints.js')); ?>"></script>  

<script type="text/javascript" src="<?php echo e(asset('assets/js/jquery.counterup.js')); ?>"></script>  
<!-- Wow animation --> 
<script type="text/javascript" src="<?php echo e(asset('assets/js/wow.js')); ?>"></script>  
<!-- progress bar   -->
<script type="text/javascript" src="<?php echo e(asset('assets/js/bootstrap-progressbar.js')); ?>"></script>
<!-- lightbox -->
<script type="text/javascript" src="<?php echo e(asset('assets/js/lightbox.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('dist/font-awesome/css/font-awesome.min.css')); ?>"></script>

 <script type="text/javascript">
  $(document).ready(function() {
 
 
// $('.modal-body2').html("<?php echo e(Session::get('notificationmessage')); ?>"); 
...
<script type="text/javascript" src="<?php echo e(asset('plugins/fuelux/fuelux.min.js')); ?>"></script> 
