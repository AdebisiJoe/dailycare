...
<head>
    ...
    <!-- <link rel="stylesheet" href="<?php echo e(asset('dist/font-awesome/css/font-awesome.min.css')); ?>"> -->
    <link rel="stylesheet" href="<?php echo e(asset('dist/fontawesome/css/all.min.css')); ?>">
    <!-- Ionicons -->
    <!--<link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">-->
    <link rel="stylesheet" href="<?php echo e(asset('dist/ionicons/css/ionicons.min.css')); ?>">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo e(asset('dist/css/AdminLTE.min.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('dist/css/bootstrapValidator.min.css')); ?>">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?php echo e(asset('plugins/daterangepicker/daterangepicker-bs3.css')); ?>">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
    folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="<?php echo e(asset('plugins/select2/select2.min.js')); ?>">     
    <link rel="stylesheet" href="<?php echo e(asset('dist/css/skins/skin-green.css')); ?>">
    <!-- iCheck 
    ...
    <!-- Date Picker -->
    <link rel="stylesheet" href="<?php echo e(asset('plugins/datepicker/css/bootstrap-datepicker.css')); ?>">

    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="<?php echo e(asset('plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/bootstrap-tour.css')); ?>">
                    ...
                    <ul class="nav navbar-nav">
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <!-- User Image -->
                                                    <img src="<?php echo e(asset('dist/img/profileimage.jpg')); ?>"
                        ...
                        <li class="dropdown messages-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="label label-success"><?php echo e($userMessageCount); ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="header">You have <?php echo e($userMessageCount); ?> messages</li>
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="tickets/<?php echo e($message->ticket_id); ?>">
                                                <h4>
                                                    <?php echo e($message->title); ?>

                                                    <small><i class="fa fa-clock-o"></i><?php echo e(date('F d, Y', strtotime($message->created_at))); ?></small>
                                                </h4>
                                                <p>
                                                    <?php echo e(str_limit($message->comment,15)); ?>
                                ...
                                <li class="footer"><a href="<?php echo e(url('/my_tickets')); ?>">See All Tickets</a></li>
                            </ul>
                        </li>
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ...
                                        <?php endif; ?>
                                        <small>Member since <?php echo $userJoinDate; ?></small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <!--<li class="user-body">
        ...
        <div class="content-wrapper">
          ...
          <div class="alert alert-danger">
              ...
              <div class="alert alert-warning">
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <?php echo e(Session::get('flash_warning')); ?></div>
                  <?php endif; ?>

                  <?php if(Session::has('flash_success')): ?>
                  <div class="alert alert-success">
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                      <?php echo e(Session::get('flash_success')); ?></div>
                      <?php endif; ?>

                      <?php if(Session::has('flash_info')): ?>
                      <div class="alert alert-info">
                          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                          <?php echo e(Session::get('flash_info')); ?></div>
                          <?php endif; ?>
                ...
                <footer class="main-footer" style="max-height: 100px;text-align: center">
                    ...
                    <strong>Copyright © <?php echo date('Y'); ?> <a href="<?php echo e(url('/home')); ?>">Unique Realty Solutions</a>.</strong> All rights reserved
                </footer>
            ...
            <nav class="navbar navbar-default navbar-static-top">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    <!-- Left Side Of Navbar -->
                    <ul class="nav navbar-nav">
                        <li><a href="<?php echo e(url('/home')); ?>">Go Back to Home Page</a></li>
                    </ul>
...
<script src="<?php echo e(asset('assets/js/jQuery-3.1.0.min.js')); ?>"></script>

<script src="<?php echo e(asset('assets/js/jquery-printme.min.js')); ?>"></script>
<!-- jQuery UI 1.11.4 -->
<script type="text/javascript" src="<?php echo e(asset('plugins/jQueryUI/jquery-ui.min.js')); ?>"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
  $.widget.bridge('uibutton', $.ui.button);
</script>
<!--<?php echo e(asset('dist/js/demo.js')); ?>-->
<!-- Bootstrap 3.3.5 -->
...
<script src=" <?php echo e(asset('assets/js/jquery.smoothscroll.js')); ?>"></script>
<script src=" <?php echo e(asset('assets/js/bootstrap-tour.js')); ?>"></script>

<script src=" <?php echo e(asset('dist/js/bootstrapValidator.min.js')); ?>"></script>
